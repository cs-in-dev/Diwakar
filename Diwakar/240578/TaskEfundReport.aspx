<%@ Page Title="" Language="C#" MasterPageFile="~/240578/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="TaskEfundReport.aspx.cs" Inherits="MoneyMagnet.SuperAdmin.TaskEfundReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        ProviderName="System.Data.SqlClient" 
               ...
               SelectCommand="SELECT [MemberID], [TxnID], [DateofTransaction], [Particulars], [Credit], [Debit] FROM [AccountMaster] WHERE DateOfTransaction<=getdate() AND Txntype IN (13,14,15) ORDER BY [DateofTransaction], [TxnID]" 
