...
namespace GrowTogether._240578
{
    public partial class Orderdetails2 : System.Web.UI.Page
    {
        ...
        SqlCommand cmd;
        Double Qty = 0, TotalTaxAmount = 0, TotalDP = 0, Total = 0, UnitPrice = 0, TotalPrice = 0, TotalAddtax = 0, Tottax = 0,TotalVat = 0,TotalBv = 0, TotalDp = 0 ;
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
               ...
               // TotalDP = TotalDP + Double.Parse(e.Row.Cells[10].Text);
                ...
                TotalVat = TotalVat + Double.Parse(e.Row.Cells[10].Text);
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
              ...
              //  e.Row.Cells[10].Text = string.Format("{0:f0}", TotalDP);
                ...
                e.Row.Cells[10].Text = string.Format("{0:f0}", TotalVat);
