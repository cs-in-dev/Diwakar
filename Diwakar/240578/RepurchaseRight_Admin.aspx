<%@ Page Title="" Language="C#" MasterPageFile="~/240578/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="RepurchaseRight_Admin.aspx.cs" Inherits="CyraShop._240578.RepurchaseRight_Admin" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1>Repurchase Right Business</h1>
    <table>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnbymemberid" runat="server" Text="Submit" OnClick="btnbymemberid_Click" ValidationGroup="vg2" />
            </td>
        </tr>
        <tr>
