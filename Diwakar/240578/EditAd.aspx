<%@ Page Title="" Language="C#" MasterPageFile="~/240578/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="EditAd.aspx.cs" Inherits="ukinvestorNEW.Admin.EditAd" %>
...
<tr>
<td align="center">Choose ad:-&nbsp; <asp:DropDownList ID="DropDownList1" runat="server" 
    ...
    <tr>
    <td>
                                                <cc1:Editor runat="server" 
            Height="200px" ID="EmailBody"></cc1:Editor>
