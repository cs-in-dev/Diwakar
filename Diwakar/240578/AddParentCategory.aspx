<%@ Page Title="" Language="C#" MasterPageFile="~/240578/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="AddParentCategory.aspx.cs" Inherits="SSRPPL._19111973.AddParentCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlAddTopic" runat="server" Font-Size="Large" ForeColor="#5D7B9D">
        Add/Delete Parent Category<br />
        <br />
        <table class="style1">
            <tr>
                <td style="text-align: right; width: 50%">Category :
                </td>
            ...
            <td style="text-align:left;width:50%">
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource2"  DataValueField="CategoryID" DataTextField="FullPAth"></asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                     ConnectionString="<%$ ConnectionStrings:conn %>" SelectCommand=" select *,  [dbo].[CategoryMape](categoryid) FullPAth from categorymaster">
                 </asp:SqlDataSource>
            ...
            <tr>
                ...
                <td class="style10" style="text-align: left; width: 50%"></td>
            </tr>
        </table>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="CategoryID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Width="100%" Style="text-align: center;">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CategoryName" HeaderText="Parent Category Name" SortExpression="CategoryName" />
                <asp:BoundField DataField="PID" HeaderText="PID" SortExpression="PID" Visible="False" />
                <%--<asp:TemplateField HeaderText="FullPAth" SortExpression="FullPAth" Visible="false">
                  <ItemTemplate>
                <asp:Label ID="Label1" runat="server" Text='<%# Bind("FullPAth") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>--%>
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" OnUpdating="SqlDataSource1_Updating"
            ...
            SelectCommand="select * from categorymaster where PID=-1 And CategoryID !=43"
