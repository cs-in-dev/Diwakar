<%@ Page Title="" Language="C#" MasterPageFile="~/240578/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="RewardEfundReport.aspx.cs" Inherits="MoneyMagnet.SuperAdmin.RewardEfundReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" Width="950px" Height="100%" ScrollBars="Both">
        ...
        AllowGrouping="True" DataSourceID="SqlDataSource1"></cc1:Grid>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        ProviderName="System.Data.SqlClient" 
               ...
               SelectCommand="SELECT [MemberID], [TxnID], [DateofTransaction], [Particulars], [Credit], [Debit] FROM [AccountMaster] WHERE DateOfTransaction<=getdate() AND txnType IN (4,3,8,6) ORDER BY [DateofTransaction], [TxnID]" 
