<%@ Page Title="" Language="C#" MasterPageFile="~/240578/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="AdminGstInvoice.aspx.cs" Inherits="Sabaic._19111973.AdminGstInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContents">
        <asp:Panel ID="Panel1" runat="server" Width="100px" Style="width: 80%; margin-left: auto; margin-right: auto;">
            ...
            <table id="tblmain" class="tb1" width="85%" cellpadding="0" cellspacing="0" style="border: 1px solid black;">
                <tr>
...
Murthal Road, Sonipat-131001
                ...
                <tr>
                    ...
                    <td style="width: 45%; border-bottom: none; border-right: none; padding: 0px; border-right: 1px solid #000000; border-left: 0px;">
