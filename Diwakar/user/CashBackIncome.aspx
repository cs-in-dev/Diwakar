<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMasterPage.master" AutoEventWireup="true" CodeBehind="CashBackIncome.aspx.cs" Inherits="Viratfuture.user.CashBackIncome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h2><center><strong>Cash Back Income</strong></center>
    </h2><br />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT DateofTransaction AS Date, Particulars, Credit AS Amount FROM AccountMaster WHERE (MemberID = @MemberID) AND (TxnType in(3)) AND (debit = 0)">
    <SelectParameters>
