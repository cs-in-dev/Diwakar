<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMasterPage.master" AutoEventWireup="true"
    CodeBehind="Welcomeletter.aspx.cs" Inherits="WGRL.User.Welcomeletter" %>
        ...
        <table id="Table1" border="0" runat="server" width="100%">
            ...
            <tr>
                <td align="center" colspan="2">
                    <h4 class="style3">
                        WELCOME TO Diwakar Retail Ltd.</h4>
                </td>
            </tr>
            <tr>
                <td align="left">
            ...
            <tr>
                <td align="left"><asp:Label ID="lbladd" runat="server" Font-Bold="true" Text=""></asp:Label>
            ...
            <tr>
                <td align="left"><asp:Label ID="lblcity" runat="server" Font-Bold="True" Visible="False"></asp:Label>
                  <%--  <b> ADDRESS&nbsp;:&nbsp;
...
&nbsp;</td>
            ...
            <tr>
                <td style="text-align: justify" colspan="2">
                    <p class="MsoNormal">
                        ...
                        of all your needs.<o:p></o:p></span></p>
                </td>
            </tr>
            <tr>
                <td style="text-align: justify" colspan="2">
            ...
            <tr>
                <td style="text-align: justify" colspan="2">
                    <p class="MsoNormal">
                        ...
                        you to participate in our Global Customer Referral System. With every purchase, 
                        ...
                        for growing your business with Diwakar Retail Ltd. Your Business Account Name are shown below: 
                        </span></b>
                ...
                <td style="text-align: justify" colspan="2">
                    ...
                    <table cellspacing="0"  style="margin-left:150px" class="style4">
                       ...
                       <%-- <tr>
                        ...
                        <tr>
                            <td>
                                Your Product Packages</td>
                           <td class="style10">
                                 <asp:Label ID="lblBIid" runat="server" Font-Bold="true" Text=""></asp:Label><asp:Label ID="LabelPDiscription" runat="server" Text=""></asp:Label>
                        ...
                        <tr>
                            <td>
                                Your Status</td>
                            <td class="style10">
                            <asp:Label ID="lblstatus" runat="server" Font-Bold="true" Text=""></asp:Label></td>
                        </tr>
                        <caption>
                             
                           <%-- <tr >
                                <td style="border-bottom: 1px solid black;border-top: 1px solid black;" padding ="5px">
                                    Your Personalized Website</td>
                                <td class="style6" 
            ...
            <tr>
                <td style="text-align: justify" colspan="2">
                    <p class="MsoNormal">
                        ...
                        branch offices or at <span class="style6"><a href="mailto:diwakarretail2017@gmail.com  ">
                      diwakarretail2017@gmail.com  </a> .</span> We are available around the clock to support 
                        you. Once again, welcome to Diwakar Retail Ltd. growing family of prosperous 
                        distributors. As we always say: <o:p>
                        <b> 
                        <span class="style10">GROWTH &amp; SUCCESS</span>.</b></o:p></span></p>
                </td>
            </tr>
            <tr>
                <td style="text-align: justify" colspan="2">
            ...
            <tr>
                <td style="text-align: justify" colspan="2">
                    <p class="MsoNormal">
                        ...
                        Progress, Working together is success in Diwakar Retail Ltd.<o:p></o:p></span></i></b></p>
                </td>
            </tr>
            <tr>
                <td style="text-align: justify" colspan="2">
            ...
            </tr><%--<li>Gorakshani Goshala Road <br />Gumati No-13 Near Petrol pump <br /> MadhuBIni , Bihar - 847211<br />M:8409229942 </li>--%>
            <tr>
                <td align="left" colspan="2">
                   <br />
 <br /></td>
