<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMasterPage.master" AutoEventWireup="true" CodeBehind="OrderDetails2.aspx.cs" Inherits="Rainsonglobal.user.OrderDetails2" %>
...
RETAIL INVOICE
    ...
    <tr><td valign="top" style="width:60%;">
    ...
    <td style="width:80%;"><table class="tblinv padd"  cellspacing="0" cellpadding="0"><tr>
   ...
   <%--  <br />TIN No : <asp:Label ID="lblTinNo" runat="server" Text="MRTC02756F"></asp:Label>--%>
    ...
    <asp:BoundField DataField="Code" HeaderText="Code" SortExpression="Code" Visible="false"/>
       ...
       <%-- <asp:BoundField DataField="Dis." HeaderText="Dis." SortExpression="Dis." DataFormatString="{0:f2}" HeaderStyle-Width="15px" ItemStyle-Width="15" ControlStyle-Width="15" FooterStyle-width="15" /> --%>
        ...
        <asp:BoundField DataField="VAT/Additional" HeaderText="Add VAT" SortExpression="VAT/Additional" DataFormatString="{0:f0}" Visible="false"/>
          <%-- <asp:BoundField DataField="Tax%" HeaderText="VAT%" SortExpression="Vats" />--%>
       <asp:BoundField DataField="TotalTax" HeaderText="Total VAT" SortExpression="TotalTax" DataFormatString="{0:f0}" />
...
<RowStyle BackColor="#E3EAEB" 
    ...
    <SortedDescendingHeaderStyle BackColor="#15524A" />
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ...
             SelectCommand="SELECT     ProductRepurchase.ProductCode Code, ProductRepurchase.ProductName,ProductRepurchase.MRP, OrderDetails.DP 'Unit Price', OrderDetails.Qty,OrderDetails.BV,ProductRepurchase.Vat, (((ProductRepurchase.Vat)))'TotalTax',OrderDetails.TotalBV, ((ProductRepurchase.MRP*OrderDetails.Qty)-(OrderDetails.TotalMRP )) 'Dis.',  
...
Murthal Road, Sonipat-131001  </span>
  ...
  <%--  <a href="ViewReceipt1.aspx">Back</a>--%>
    ...
    <a href="ViewOrders1.aspx">Back</a>
