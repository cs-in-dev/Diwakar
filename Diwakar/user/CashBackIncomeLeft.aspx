<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMasterPage.master" AutoEventWireup="true" CodeBehind="CashBackIncomeLeft.aspx.cs" Inherits="Viratfuture.user.CashBackIncomeLeft" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h2><center><strong>My Left Cash Back Income</strong></center>
    </h2><br />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT DateofTransaction AS Date, Particulars, Credit AS Amount from  [esc].[MyLeftDownLine](@MemberID) inner join AccountMaster on MemberID=@MemberID Where AccountMaster.Particulars like '%'+UserCode+'%' and TxnType=3">
    <SelectParameters>
