            ...
            <td>
                <asp:Panel ID="InformationPanel" runat="server" Style="margin-top: 0px">
                    <table align="center" style="width: 660px">
                        ...
                        <tr>
                            <td class="style40">
                                <asp:Label ID="Label1" runat="server" CssClass="text" Text="USER ID"></asp:Label>
                            </td>
                            <td class="style26">
                                <asp:TextBox ID="txtBAName" runat="server" Width="170px" CssClass="UpperCase" Enabled="false"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Label ID="Label2" runat="server" CssClass="text" Text="USER NAME"></asp:Label>
                            </td>
                            <td class="style26">
                        ...
                        <tr>
                            ...
                            <td class="style26">
                                <asp:TextBox ID="txtAddress" runat="server" MaxLength="1000" Height="28px" Width="165px" CssClass="UpperCase"
                        ...
                        <tr>
                            ...
                            <td class="style26">
                                <asp:TextBox ID="txtAccountNo" runat="server" MaxLength="30" CssClass="UpperCase"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="style26">
                                <asp:TextBox ID="txtBranchName" runat="server" MaxLength="30" ReadOnly="true" CssClass="UpperCase"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td class="style26">
                                <asp:TextBox ID="txtAadharnumber" runat="server" MaxLength="16" ReadOnly="true" CssClass="UpperCase"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="style40">
                            ...
                            <td style="font-size: 11px">PAN No.</td>
                            <td class="style26">
                                <asp:TextBox ID="txtPanNo" runat="server" MaxLength="10" ReadOnly="true" CssClass="UpperCase"></asp:TextBox>
