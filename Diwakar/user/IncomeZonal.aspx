<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMasterPage.master" AutoEventWireup="true" CodeBehind="IncomeZonal.aspx.cs" Inherits="WGRL.IncomeZonal" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    </asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center style="font-size: x-large;"><strong>ZONAL POOL</strong></center>
   ...
   <tr>
       <td>
           ...
           <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
               ...
               SelectCommand="select DateOFTransaction, Particulars, Credit from accountmaster where txntype=21 and memberid=@usercode ORDER BY DateOFTransaction desc">
               <SelectParameters>
