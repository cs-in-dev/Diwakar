...
{
    public partial class AddTopUp : System.Web.UI.Page
    {
        ...
        {
            string sPinAmount = "0";
            if (sPinCode != null && sPinCode1 == "txntype2") //Use Activation  1
            {
                con.Open();
                String ss = "select * from tblPinMaster where  pinCode ='" + sPinCode + "'";
                ...
                //if (float.Parse(sPinAmount.ToString()) < 5000)
                //{
                //    Label2.Text = "Amount Insufficient for Activation";
                //    Label2.ForeColor = Color.Red;  
                //    return;
                //}
                SqlCommand cmd = new SqlCommand("RenewSubscription", con);
