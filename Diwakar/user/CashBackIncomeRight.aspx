<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMasterPage.master" AutoEventWireup="true" CodeBehind="CashBackIncomeRight.aspx.cs" Inherits="Viratfuture.user.CashBackIncomeRight" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h2><center><strong>My Right Cash Back Income</strong></center>
    </h2><br />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT DateofTransaction AS Date, Particulars, Credit AS Amount from  [esc].[MyRightDownLine](@MemberID) inner join AccountMaster on MemberID=@MemberID Where AccountMaster.Particulars like '%'+UserCode+'%' and TxnType=3">
    <SelectParameters>
