<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMasterPage.master" AutoEventWireup="true" CodeBehind="performancebonus.aspx.cs" Inherits="CyraShop.user.performancebonus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h2><center><strong>Performance Bonus</strong></center></h2><br />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    SelectCommand="SELECT DateofTransaction AS Date, Particulars, Credit AS Amount FROM AccountMaster WHERE (MemberID = @MemberID) AND (TxnType in(9)) AND (debit = 0)">
    <SelectParameters>
